...
template <typename T> Elip::Vector<T> ToVect(int from[])
{
    Elip::Vector<T> co;
    co.vector = from;
    return co;
}
template <typename T> Elip::Vector<T> ToVect(float from[])
{
    Elip::Vector<T> co;
    co.vector = from;
    return co;
}
template <typename T> Elip::Vector<T> ToVect(unsigned int from[])
{
    Elip::Vector<T> co;
    co.vector = from;
    return co;
...
template <typename T> Elip::Vector<T> ToVect(const char *from[])
{
    Elip::Vector<T> co;
    co.vector = from;
    return co;
}
template <typename T> Elip::Vector<T> ToVect(std::vector<T> from)
{
    Elip::Vector<T> co;
    co.vector = from;
    return co;
